...
interface NexusPrismaInputs {
  Query: {
    users: {
  filtering: 'id' | 'email' | 'name' | 'posts' | 'AND' | 'OR' | 'NOT'
  ordering: 'id' | 'email' | 'name'
}
    posts: {
  filtering: 'id' | 'authorId' | 'content' | 'published' | 'title' | 'AND' | 'OR' | 'NOT' | 'author'
  ordering: 'id' | 'authorId' | 'content' | 'published' | 'title' | 'author'
}
